...
public class CategoriasController {
	...
	public ResponseEntity<List<Categoria>> findAll() {
		...
		List<Categoria> categorias = (List<Categoria>) baseService.findAll();
	...
	public ResponseEntity<Categoria> findById(@PathVariable Integer id) {
		...
		Categoria categoria = optionalCategoria.orElseThrow(() -> new ObjectNotFoundException("Categoria não encontrado."));
