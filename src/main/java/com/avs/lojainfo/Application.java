...
public class Application implements CommandLineRunner {	
	...
	public void run(String... args) throws Exception {
		...
		catInformatica.getProdutos().addAll(Arrays.asList(prodNotebook, prodDesktop, prodTeclado, prodMouse, prodImpressora));
		...
		categoriaService.saveAll(Arrays.asList(catInformatica, catEscritorio));
		produtoService.saveAll(Arrays.asList(prodNotebook, prodDesktop, prodTeclado, prodMouse, prodImpressora));
